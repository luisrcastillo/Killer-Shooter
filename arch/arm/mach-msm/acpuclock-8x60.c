...
#define L_VAL_SCPLL_CAL_MAX	0x20 /* = 1512 MHz with 27MHz source */
...
//	[17] = {1674000,  1, 0x1F, 1200000, 1300000, 3},
};
...
static struct clkctl_acpu_speed acpu_freq_tbl_v2[] = {
  ...
  { {1, 1}, 1728000,  ACPU_SCPLL, 0, 0, 1, 0x20, L2(16), 1250000, 0x03006000},
  { {0, 0}, 0 },
};
